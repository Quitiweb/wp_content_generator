...
class wp_content_generator {
	...
	public function __construct() {
		if ( defined( 'wp_content_generator_PLUGIN_NAME_VERSION' ) ) {
			$this->version = wp_content_generator_PLUGIN_NAME_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'wp_content_generator';
	 ...
	 * - wp_content_generator_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wp_content_generator-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wp_content_generator-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-wp_content_generator-admin.php';
	...
	private function define_public_hooks() {
		...
		$plugin_public = new wp_content_generator_Public( $this->get_plugin_name(), $this->get_version() );
