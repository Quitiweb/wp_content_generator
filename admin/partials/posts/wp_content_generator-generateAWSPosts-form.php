    ...
    <table class="form-table">
        <tr valign="top">
            ...
            <td>
                ...
                <p class="description">Select the main category for the post</p>
            </td>
        </tr>
        <tr valign="top">
            <th scope="row">Additional Categories</th>
            <td>
                ...
                <p class="description">Choose additional categories for the post (optional)</p>
            </td>
        </tr>
        <tr valign="top">
