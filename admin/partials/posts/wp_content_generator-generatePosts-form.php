<?php $wp_content_generatorPosTypes = wp_content_generatorGetPostTypes(); ?>
...
<form method="post" id="wp_content_generatorGenPostForm" class="wp_content_generatorCol-9">
    ...
    <table class="form-table">
        <tr valign="top">
	        ...
	        <td>
	        	<select name="wp_content_generator-posttype">
	        		<?php foreach ($wp_content_generatorPosTypes as $key => $value): ?>
        ...
        <tr valign="top">
	        ...
	        <td>
	        	<input type="number" name="wp_content_generator-post_count" class="wp_content_generator-post_count"  placeholder="Number of posts" value="10" max="500" min="1" />
